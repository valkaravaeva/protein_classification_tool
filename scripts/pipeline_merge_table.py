#!/usr/bin/env python3
"""
Merge parsed InterPro annotations, filtered HMMER (KO) hits, and the
accession-to-genome/taxonomy mapping into one combined per-accession annotation
table.

Nextflow process: mergeTables
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description='Merge parsed InterPro annotations, filtered HMMER (KO) hits, and the accession-to-genome/taxonomy mapping into one combined per-accession annotation table.'
    )
    parser.add_argument("hmmer", help="merged filtered hmmer file")
    parser.add_argument("interpro", help="merged parsed interpro file")
    parser.add_argument("accgen", help="accession - genome map")
    parser.add_argument("taxfile", help="taxonomy file")
    parser.add_argument("kopath", help="'/lisc/scratch/ecogenomics/karavaeva/kegg/ko00001_level_C.tsv' #special kegg path file")
