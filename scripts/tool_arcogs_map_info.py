#!/usr/bin/env python3
"""
Build an annotated arCOG hit table: map every filtered arCOG hit to its arCOG/asCOG
model, functional category and definition, and attach genome and taxonomy
information.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description='Build an annotated arCOG hit table: map every filtered arCOG hit to its arCOG/asCOG model, functional category and definition, and attach genome and taxonomy information.'
    )
    parser.add_argument("wrkdir", help="path to the directory of arcog database files")
    parser.add_argument("all_arcog", help="your filtered arcog output file")
    parser.add_argument("taxfile", help="taxonomy.tsv file")
    parser.add_argument("savefile", help="path to save your file")
